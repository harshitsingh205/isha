...
Ab hisse mein daakhil mere bas wo yaadein ✨
    ...
    const typingSpeed = 75; // Base ms per character
    const jitter = 40;      // Random variation in typing speed
        ...
        if (audio.paused) {
            ...
            if (playPromise !== undefined) {
                playPromise.catch(error => {
                    ...
                    alert('Unable to play audio. Please check the file path or try a different browser.');
                });
            }
        } else {
            audio.pause();
    ...
    audio.addEventListener('error', (e) => {
        ...
        console.error('Audio loading failed:', errorMsg);
    });
